package vn.com.taptap.store.util;

import org.apache.commons.io.FileUtils;
import vn.com.taptap.store.ColumnMapping;
import vn.com.taptap.store.arithmetic.SearchCardId;
import vn.com.taptap.store.arithmetic.SearchDirection;
import vn.com.taptap.store.arithmetic.SearchFunction;
import vn.com.taptap.store.arithmetic.SearchTimestamp;
...
public class SearchUtil {
    ...
    /*
    * - Search by column id
    * - Split to many search threads
    * - Use strategy pattern to search with option algorithms
    * */
